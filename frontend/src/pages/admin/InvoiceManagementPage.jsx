...
const inlineStyles = `
/* ==========================================================================
   Invoice Management - Direct Embedded Theme
   ========================================================================== */
.im-page-wrapper {
  display: flex;
  ...
  max-width: 1440px;
  margin: 0 auto;
  animation: imFadeIn 0.35s ease-out;
}
...
/* Hero Banner */
.im-hero-banner {
  background: linear-gradient(135deg, #0f172a 0%, #0c4a6e 40%, #0284c7 80%, #38bdf8 100%);
  border-radius: 16px;
  padding: 28px 32px;
  color: #ffffff;
  position: relative;
...
.im-stat-card:hover .im-stat-icon-wrap {
...
.im-select-filter .ant-select-selector {
  border-radius: 10px !important;
  height: 40px !important;
...
.im-table .ant-table-thead > tr > th {
  background: #f8fafc !important;
...
.im-table .ant-table-tbody > tr > td {
  padding: 14px 16px !important;
}

.im-table .ant-table-tbody > tr:hover > td {
  background: #f8fafc !important;
}
...
.im-action-btn.view { color: #0284c7; background: #f0f9ff; border-color: #e0f2fe; }
.im-action-btn.view:hover { background: #0284c7; color: #ffffff; }

.im-action-btn.edit { color: #d97706; background: #fffbeb; border-color: #fef3c7; }
.im-action-btn.edit:hover { background: #d97706; color: #ffffff; }

.im-action-btn.delete { color: #e11d48; background: #fff1f2; border-color: #ffe4e6; }
.im-action-btn.delete:hover:not(:disabled) { background: #e11d48; color: #ffffff; }
...
.im-descriptions .ant-descriptions-item-label {
...
@media (max-width: 992px) {
  .im-page-wrapper { padding: 16px; gap: 16px; }
  .im-hero-banner { padding: 20px 24px; }
}

@media (max-width: 768px) {
  .im-hero-inner { flex-direction: column; align-items: flex-start; }
  .im-hero-right { width: 100%; }
  .im-filter-row { flex-direction: column; align-items: stretch; }
  .im-filter-controls { width: 100%; }
  .im-select-filter, .im-year-input { flex: 1; }
}
`;
...
const statusMeta = {
  draft: { bg: "#e0f2fe", color: "#0369a1", icon: <ClockCircleOutlined />, label: "Chờ nhập chỉ số" },
